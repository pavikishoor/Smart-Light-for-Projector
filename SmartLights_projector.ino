...
//WIFI configuration
const char* ssid = "Mr.manoj";           
const char* password =  "angrybird";    

const char* mqttServer = "soldier.cloudmqtt.com";  
const char* mqttUser = "vmcudkes";             
const char* mqttPassword = "0YK2MLj06TL3";     
const int mqttPort = 17226;                    
const char* mqttTopicSub ="home/L1";           
